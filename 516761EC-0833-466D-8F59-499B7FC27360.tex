...
$ D=\left\{(x,y)|x^2+y^2\leq 1,y\geq 0\right\}$
...
若化为累次积分后， 一元积分有用{\darkgreen 周期性}的机会， 则可化简计算。
...
\startalign
 ...
 \NC    \NC = \frac{1}{2}\cdot\ln\frac{3}{2}+\int_0^1\frac{dx}{1+2x^2}-\int_0^1\frac{dx}{1+x^2}  
       = \frac{1}{2}\cdot\ln\frac{3}{2}+\frac{1}{\sqrt{2}}\cdot\arctan \sqrt{2}-\frac{\pi}{4} \NR
\stopalign
\stopformula
...
设平面区域 $D$ 由曲线 $x=t-\sin t$, $y=1-\cos t$, $0\leq t \leq 2\pi$ 与 $x$ 轴围成， 计算二重积分 
...
\startalign
  ...
  \NC \NC = \int_0^{2\pi} \left[(t-\sin t)(1-\cos t)^2 + (1-\cos t)^3\right] dt  
        = 5\pi + 3\pi ^2\NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC  I  \NC = \iint_D \frac{y^3}{(1+x^2+y^4)^2}dxdy  
       = \int_0^{+\infty}dx \int_0^{\sqrt{x}}\frac{y^3}{(1+x^2+y^4)^2} dy \NR
  \NC \NC = \frac{1}{4}\int_0^{+\infty} \left( \frac{1}{1+x^2} - \frac{1}{1+2x^2} \right) dx 
       = \frac{2-\sqrt{2}}{16}\pi \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC I \NC = \int_{-\frac{\pi}{2}}^{\frac{\pi}{2}} dy\int_{y-3}^{2y+5} (1+x)\sqrt{1-\cos ^2y}\cdot dx  
       = \int_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\sqrt{1-\cos ^2y}\cdot \left.\left(x+\frac{x^2}{2}\right)\right|_{y-3}^{2y+5}dy \NR
  \NC   \NC = \int_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\left(\frac{3}{2}y^2+14y+16\right)\sqrt{1-\cos ^2y}\cdot dy 
           = \int_0^{\frac{\pi}{2}}\left(3y^2+32\right)\sin y\cdot dy\NR
 \NC  \NC   = 3\pi+26 \NR
\stopalign
\stopformula

二重积分的计算之 $Y$ 型区域。   \hfill 例02毕。
%%
%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
% 内容分割线 2020.07.16
%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
\startalign
  ...
  \NC  \NC  = 2\int_0^{\frac{\pi}{2}}d\theta\int_{a\sin\theta}^{2a\sin\theta}r^3dr 
            = 2\int_0^{\frac{\pi}{2}}\left.\frac{r^4}{4}\right|_{a\sin\theta}^{2a\sin\theta}d\theta 
            = \frac{15a^4}{2}\int_0^{\frac{\pi}{2}}\sin^4\theta d\theta  \NR
  \NC  \NC  = \frac{15a^4}{2}\cdot\frac{3}{4}\cdot\frac{1}{2}\cdot\frac{\pi}{2}
            =\frac{45\pi}{32}a^4 \NR
\stopalign
\stopformula
Wallis公式 \hfill 例03毕。
%%
...
\startformula
\startalign
  \NC I \NC = \int_0^{\frac{\pi}{2}}d\theta\int_{2\cos\theta}^2r^2\cdot r dr+\int_{\frac{\pi}{2}}^{\frac{3\pi}{4}}d\theta\int_0^2r^2\cdot r dr  
          = 4\int_0^{\frac{\pi}{2}}\left(1-\cos^4\theta\right)d\theta + \frac{\pi}{4}\cdot \frac{1}{4}\cdot2^4  \NR
...
已知平面区域 $D=\left\{(x,y)|x^2+y^2\leq 2y\right\}$， 计算二重积分
...
已知平面区域 $D$ 满足 $|x|\leq y$, $\left(x^2+y^2\right)^3\leq y^4$， 求
\startformula
...
\startformula
\startalign
 \NC I \NC = \int \frac{1}{\sin x}dx 
           = \int\frac{1}{2\sin \frac{x}{2}\cdot \cos \frac{x}{2}} dx 
           = \int \frac{\displaystyle \frac{1}{2\cos^2 \frac{x}{2}} }{\tan \displaystyle \frac{x}{2}} dx 
           = \int \frac{1}{\tan \frac{x}{2}} d\left(\tan \frac{x}{2}\right) \NR
  \NC  \NC = \ln \left|\tan \frac{x}{2}\right| +C\NR
\stopalign
\stopformula
...
=\int \frac{d\left(x+\frac{\pi}{2}\right)}{\sin\left(x+\frac{\pi}{2}\right)}dx 
...
\startformula
\startalign
 \NC I \NC  =  \int \frac{1}{\sin^3 x}dx = -\int \frac{1}{\sin x }d (\cot x) 
...
积分公式表
$(85)$ $\displaystyle \int \tan x dx = -\ln |\cos x| +C$

%拓展

积分公式表
$(86)$ $\displaystyle \int \cot x dx = \ln |\sin x| +C$
...
\startalign
  ...
  \NC \NC  = -\int_0^1 \frac{1}{\cos x}d(\cos x) = -\ln|\cos x | \big|_0^1  
       = -\ln \cos 1 \NR
\stopalign
\stopformula
...
\startformula
I = \int_?^?dy \int _ ? ^? \frac{\cot x }{x} dx\, = \, (\kern2em)
\stopformula
...
求圆柱面 $x^2+y^2=ay\,(a>0)$, 锥面 $z=\sqrt{x^2+y^2}$ 与平面 $z=0$ 所围成的立体体积 $V$。
...
\startformula
\startalign
  \NC V \NC =\iint_D r^2drd\theta = 2\int_0^{\frac{\pi}{2}}d\theta\int_0^{a\sin\theta}r^2dr  
        = \frac{2a^3}{3}\int_0^{\frac{\pi}{2}}\sin^3\theta d\theta =\frac{4}{9}a^3 \NR
\stopalign
\stopformula

二重积分的应用之体积。 极坐标。 Wallis公式。 \hfill 例02毕。
%%
%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
% 内容分割线 2020.07.16
%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
\startformula
\startalign
  \NC V  \NC = \iint_D (2a-\sqrt{x^2+y^2}-\frac{x^2+y^2}{a})dxdy
             = \int_0^{2\pi}d\theta\int_0^a(2a-r-\frac{r^2}{a})r dr  \NR
  \NC    \NC =\frac{5\pi a^3}{6} \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC V \NC = \iint_D\frac{a\phi(x)+b\phi(y)}{\phi(x)+\phi(y)}dxdy   
       = \iint_D\frac{a\phi(y)+b\phi(x)}{\phi(y)+\phi(x)}dxdy \NR
  \NC   \NC = \frac{1}{2}\iint_D \left(\frac{a\phi(x)+b\phi(y)}{\phi(x)+\phi(y)} + \frac{a\phi(y)+b\phi(x)}{\phi(y)+\phi(x)}\right)dxdy \NR
...
\startformula
\startalign
  \NC I_y  \NC = \iint_D \mu x^2d\sigma 
               = \mu\int_0^{\sqrt{2}}x^2dx \int_{x^2-1}^{\frac{1}{3}\left(5-x^2\right)} dy 
               = \frac{4}{3}\mu \int_0^{\sqrt{2}}\left(2x^2-x^4\right)dx \NR
  \NC    \NC  =\frac{32\sqrt{2}}{45}\mu \NR
\stopalign
\stopformula
转动惯量 \hfill 例05毕。
%%
...
\iiint_\Omega f(x,y,z)dv = 
 \startcases[align={right,left},distance=3pt]
   \NC 2\displaystyle \iiint_{\Omega_1} f(x,y,z) dv,  \NC \, $f(x,y,z) = f(-x,y,z)$ \NR
...
比如， 设 $\Omega = \left\{(x,y,z)| x^2+y^2+z^2\leq R^2\right\}$， 则
...
在直角坐标系的先一后二法中， 若 $\displaystyle \iint_{D_{xy}}d\sigma$ 适用于极坐标系，则令
\startformula
\startcases
  \NC x  = r\cos\theta \NR
  \NC y  = r\sin\theta \NR
...
(2) $\displaystyle \frac{x}{a}+\frac{y}{b}+\frac{z}{c}=1,\quad a,b,c>0$
...
\startalign
  ...
  \NC = \NC \iiint_{\Omega_{uvw}} f\left[x(u,v,w),y(u,v,w),z(u,v,w)\right]\cdot \left | \frac{\partial (x,y,z)}{\partial (u,v,w)} \right | \cdot dudvdw \NR
\stopalign
\stopformula
%%
%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
$(1)$ 若 $x=r\cos\theta$, $y=r\sin\theta$, $z=z$ ，
\startformula
J = 
...
$(2)$ 若 $x=r\sin\phi\cos\theta$, $y=r\sin\phi\sin\theta$, $z=r\cos\phi$ ，
\startformula
J = 
...
\startformula
\bar{x}=\frac{\displaystyle \iiint_\Omega x\rho(x,y,z)dv}{\displaystyle \iiint_\Omega \rho(x,y,z)dv},\,
\bar{y}=\frac{\displaystyle \iiint_\Omega y\rho(x,y,z)dv}{\displaystyle \iiint_\Omega \rho(x,y,z)dv},\,
\bar{z}=\frac{\displaystyle \iiint_\Omega z\rho(x,y,z)dv}{\displaystyle \iiint_\Omega \rho(x,y,z)dv}
\stopformula
...
I_O=\iiint_\Omega \left(x^2+y^2+z^2\right) \rho(x,y,z)dv
\stopformula
...
5. 引力。
\index{引力}
对于空间物体 $\Omega$， 其体积密度为 $\rho(x,y,z)$， 则该物体对点 $\left(x_0,y_0,z_0\right)$ 处的质量为 $m$ 的质点的引力 $\left(F_x,F_y,F_z\right)$ 的计算公式为

\startformula
F_x=Gm\iiint_\Omega \frac{\rho(x,y,z)\left(x-x_0\right)}{\left[\left(x-x_0\right)^2+\left(y-y_0\right)^2+\left(z-z_0\right)^2\right]^{\frac{3}{2}}}dv
\stopformula

\startformula
F_y=Gm\iiint_\Omega \frac{\rho(x,y,z)\left(y-y_0\right)}{\left[\left(x-x_0\right)^2+\left(y-y_0\right)^2+\left(z-z_0\right)^2\right]^{\frac{3}{2}}}dv
\stopformula

\startformula
F_z=Gm\iiint_\Omega \frac{\rho(x,y,z)\left(z-z_0\right)}{\left[\left(x-x_0\right)^2+\left(y-y_0\right)^2+\left(z-z_0\right)^2\right]^{\frac{3}{2}}}dv
\stopformula
...
已知 $y(x)$ 满足微分方程
\startformula
y'-xy=\frac{1}{2\sqrt{x}}\cdot e^{\frac{x^2}{2}},\quad y(1)=\sqrt{e},
\stopformula
...
计算三重积分 $\displaystyle \iiint_\Omega (x+z)dv$， 其中 $\Omega$ 是由曲面 $z=\sqrt{x^2+y^2}$ 与 $z=\sqrt{1-x^2-y^2}$ 所围成的区域。
...
解答过程：法一：
由 $\Omega$ 关于 $yoz$ 坐标面对称， 知 $\displaystyle \iiint_\Omega x dv=0$， 所以

\startformula
\startalign
  \NC  \NC \iiint_{\Omega} (x+z)dv \NR
  \NC  \NC  = \int_0^{2\pi}d\theta \int_0^{\frac{\pi}{4}}d \phi \int_0^1 r^3\cos\phi \sin\phi dr  
        = \left. 2\pi\cdot \frac{1}{2}\sin^2\phi \right|_0^{\frac{\pi}{4}}\cdot \frac{1}{4} \NR
  \NC  \NC  = \frac{\pi}{8} \NR
\stopalign
\stopformula
...
设 $\Omega$ 是由锥面 
\startformula
x^2+(y-z)^2=(1-z)^2, \quad 0\leq z \leq 1
\stopformula

与平面 $z=0$ 所围成的锥体， 求 $\Omega$ 的形心坐标。
...
\startformula
\startalign
  \NC \iiint_{\Omega}dv \NC =\iiint_{\Omega_{uvw}}dudvdw = \int_0^1dw\iint_{u^2+v^2\leq w^2} dudv
       = \int_0^1 \pi w^2dw = \frac{\pi}{3}\NR
\stopalign
\stopformula

\startformula
\startalign
  \NC \iiint_{\Omega}ydv \NC =\iiint_{\Omega_{uvw}}(v+1-w)dudvdw   
       =\iiint_{\Omega_{uvw}}vdw + \iiint_{\Omega_{uvw}}(1-w)dudvdw\NR
  \NC  \NC  = \frac{\pi}{12} \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC \iiint_{\Omega}zdv \NC =\iiint_{\Omega_{uvw}}(1-w)dudvdw  
       = \int_0^1 (1-w) dw\iint_{u^2+v^2\leq w^2} dudv \NR
  \NC  \NC = \frac{\pi}{12} \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC  y(x) \NC  =e^{\displaystyle -\int -x dx}\cdot \left[\int \frac{1}{2\sqrt{x}} \cdot e^{\frac{x^2}{2}} \cdot e^{\displaystyle \int -x dx}dx+C\right] \NR
  \NC  \NC = e^{\frac{x^2}{2}}\left(\sqrt{x}+C\right) \NR
\stopalign
\stopformula
代入初值 $y(1)=\sqrt{e}$， 有 $C=0$， 即 $y(x)=\sqrt{x}\cdot e^{\frac{x^2}{2}}$
...
\startformula
\startalign
  \NC  V_x  \NC = \iiint_{\Omega}dv=\int_1^2 dx\iint_{y^2+z^2\leq xe^{x^2}}dydz  
        = \int_0^1\pi xe^{x^2}dx
        =\frac{\pi}{2}\left(e^4-e\right) \NR
\stopalign
\stopformula
...
\startalign
  ...
  \NC  \NC = 3\int_0^{\frac{\pi}{2}}d\theta \int_0^{\frac{\pi}{2}}d\phi \int_0^R r^3\cos\phi \sin\phi dr  
       = \frac{3\pi}{2}\int_0^{\frac{\pi}{2}}\sin\phi \cos\phi d\phi\int_0^Rr^3dr \NR
...
设 $\Omega$ 由拋物面 $y=\sqrt{x}$, $x+z=\displaystyle \frac{\pi}{2}$, $y=0$, $z=0$ 围成，计算
...
\startalign
  ...
  \NC  \NC  = \int_0^{\frac{\pi}{2}} dx \int_0 ^ {\sqrt{x}} dy \int_0^{\frac{\pi}{2}-x} \frac{y\sin x }{x} dz    
       = \int_0^{\frac{\pi}{2}} \left(\frac{\pi}{2}-x\right)\frac{\sin x }{x} dx \int_0^{\sqrt{x}} y dy  
            \NR
  \NC  \NC = \frac{1}{2}\int_0^{\frac{\pi}{2}}\left(\frac{\pi}{2}-x\right)\sin x dx 
...
解答过程：由极坐标和 Wallis 公式， 得
\startformula
\startalign
  \NC I  \NC = \iint_{D_{xy}}d\sigma \int_0^{\frac{x^2+y^2}{8}} \sqrt{x^2+y^2} dz \NR
  \NC    \NC = \int_0^{\pi} d\theta \int_0^{2\sin\theta}r dr \int_0^{\frac{r^2}{8}} r dz  
         = \frac{1}{8}\int_0^{\pi} d\theta\int_0^{2\sin\theta}r^4dr  
         = \frac{4}{5}\int_0^{\pi} \sin^5\theta d\theta \NR
  \NC    \NC = \frac{4}{5}\left(2\times \frac{4}{5}\times \frac{2}{3}\right) 
             =  \frac{64}{75} \NR
\stopalign
\stopformula
...
添加辅助面 $\Sigma_1: x=0$, 方向指向 $x$ 轴的负半轴（负向）， 记 $\Sigma +\Sigma_1$ 围成的封闭区域为 $\Omega$， 则 $\Sigma +\Sigma_1$ 的总体的方向取为封闭区域的外侧， 即满足高斯公式的封闭性和方向性。
 由高斯公式、 截面法计算三重积分， 有
\startformula
\startalign
  \NC I \NC = \oiint_{\Sigma +\Sigma_1} - \iint_{\Sigma_1}  xdydz+(y^3+z)dxdz+z^3dxdy \NR
  \NC  \NC = \int_0^1 dx\iint_{y^2+z^2\leq \frac{1-x^2}{3}} (1+3y^2+3z^2)dydz  
       = \int_0^1dx\int_0^{2\pi} d\theta \int_0^{\sqrt{\frac{1-x^2}{3}}} (1+3r^2)rdr \NR
...
解答过程：
以 $z=\displaystyle \frac{\sqrt{3}}{3}\sqrt{x^2+y^2}$ 为分界面， 将区域 $\Omega$ 分为 $\Omega_1$， $\Omega_2$ 上下两部分， 则

\startformula
\startalign
  \NC I  \NC = \iiint_{\Omega_1}z^2 dv + \iiint_{\Omega_2}z^2 dv\NR
  \NC    \NC = \int_0^{2\pi} d\theta \int_0^{\frac{\pi}{3}} d\phi \int_0^R r^4\cos^2\phi\sin\phi dr  
    + \int_0^{2\pi} d\theta \int_{\frac{\pi}{3}}^{\frac{\pi}{2}} d\phi \int_0^{R\cos\phi} r^4\cos^2\phi\sin\phi dr  \NR
  \NC    \NC = ...\text{\darkgreen 课后练习}... = \frac{59}{480}\pi R^5 \NR
\stopalign
\stopformula
球面坐标 \hfill 例05毕。
...
\startformula
\startalign
  \NC f(t) \NC = \int_0^{2\pi} d\theta \int_0^{\pi} d\phi \int_0^t f(r)r^2\sin\phi dr + t^3  
         = 4\pi\int_0^t r^2f(r)dr +t^3  \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC f(t) \NC = e^{\displaystyle \int 4\pi t^2dt}\left(\int 3t^2 e^{-\displaystyle \int 4\pi t^2 dt} dt +C\right) \NR
  \NC    \NC = e^{\displaystyle \frac{4}{3}\pi t^3}\left(\int 3t^2 e^{-\displaystyle \frac{4}{3}\pi t^3} dt +C\right)  
      = Ce^{\displaystyle \frac{4}{3}\pi t^3}-\frac{3}{4\pi} \NR
\stopalign
\stopformula

由 $f(0)=0$, $C=\displaystyle \frac{3}{4\pi}$， 故
\startformula
f(t) = \frac{3}{4\pi}\cdot \left(e^{\displaystyle \frac{4}{3}\pi t^3}-1\right),\, f(1)= \frac{3}{4\pi}\left(e^{\displaystyle \frac{4}{3}\pi }-1\right)
\stopformula
...
\startalign
  ...
  \NC \NC = \int_0^{2\pi}d\theta\int _0^{\frac{\pi}{4}}d\phi \int_1^{\frac{1}{\cos\phi}} (r-1)r^2\sin\phi dr  
    + \int_0^{2\pi}d\theta\int _0^{\frac{\pi}{4}}d\phi \int_0^1 (1-r)r^2\sin\phi dr \NR
  ...
  \NC \NC = \frac{\pi}{12}\left(2-\sqrt{2}\right) + \frac{\pi}{12}\left(3\sqrt{2}-4\right) 
          = \frac{\pi}{12}\left(2-\sqrt{2}\right)
          = \frac{\pi}{6}\left(\sqrt{2} -1\right) \NR
\stopalign
\stopformula
...
{\bf 考点：} 三重积分的应用之变型 （第二类曲面积分 $\darkgreen \rightarrow$ 高斯公式 $\darkgreen \rightarrow$ 三重积分）。  椭球面方程。 高斯公式。 第二类曲面积分。
\index{第二类曲面积分}
\index{高斯公式}
\index{广义球面坐标}
...
$\Omega = \left\{\, (x,y,z)| 1-x^2-4y^2-z^2\geq 0\right\}$, $\Sigma$ 为 $\Omega$ 的表面， 即为椭球面
$x^2+4y^2+z^2=1$ 时， $I$ 最大。

$(2)$ 由广义球面坐标系 $x=r\sin\phi\cos\theta$, $y=\displaystyle \frac{1}{2}r\sin\phi\sin\theta$, 
$z=r\cos\phi$, 有
\startformula
\startalign
...
\index{69 例 09}
\index{p372, 例18.10}
求曲面 $z=2\left(x^2+y^2\right)$, $x^2+y^2=x$, $x^2+y^2=2x$ 和 $z=0$ 所围几何体的体积。
\index{体积}

\medskip

{\bf 考点：} 三重积分的应用之几何体的体积。 积分次序先一后二。 旋转抛物面。 Wallis 公式。
\index{三重积分}
\index{体积}
\index{先一后二}
\index{极坐标}
...
解答过程： $\Omega = \left\{(x,y,z)| 0\leq z \leq 2\left(x^2+y^2\right), x\leq x^2+y^2 \leq 2x\right\}$,  所以
\startformula
\startalign
  \NC V \NC = \iiint_\Omega dv 
            =  \iint_{x\leq x^2+y^2 \leq 2x} dxdy \int_0^{2\left(x^2+y^2\right)}dz \NR
  \NC \NC = \iint_{x\leq x^2+y^2\leq 2x}2\left(x^2+y^2\right)dxdy  
       = \int_{-\frac{\pi}{2}}^{\frac{\pi}{2}}d\theta\int_{\cos\theta}^{2\cos\theta}2r^3 dr
      =\frac{1}{2}\int_{-\frac{\pi}{2}}^{\frac{\pi}{2}} 15 \cos ^4\theta d\theta \NR
  \NC  \NC = 15\cdot \frac{3}{4} \cdot \frac{1}{2}\cdot  \frac{\pi}{2} 
           = \frac{45\pi}{16} \NR
\stopalign
\stopformula
...
解答过程：$(1)$ 直线 $L$ 的方程为 $\displaystyle \frac{x-1}{1}=\frac{y}{-1}=\frac{z}{-1}$， 写成参数 $t$ 的表达式为
\startformula
\startmathcases
   \NC x = 1+t,  \NR
   \NC y  = -t, \NR
...
$(2)$ 设 $\Omega$ 的形心坐标为 $\left(\bar{x},\bar{y},\bar{z}\right)$， 根据对称性， 得 $\bar{x}=\bar{y}=0$。

设 $D_z=\left\{(x,y)|x^2+y^2\leq 2z^2-2z+1\right\}$， 则
\startformula
\Omega:
\startmathcases
   \NC (x,y)\in D_z,  \NR
...
\startformula
\startalign
  \NC   \iiint_{\Omega}dxdydz \NC  = \int_0^2dz \iint_{D_z}dxdy  
       = \pi \int_0^2 (2z^2-2z+1)dz \NR
  \NC \NC = \pi\left. \left(\frac{2}{3}z^3-z^2+z\right)\right|_0^2  
       =\frac{10\pi}{3} \NR
\stopalign
\stopformula
\startformula
\startalign
  \NC \iiint_{\Omega}zdxdydz \NC = \int_0^2zdz \iint_{D_z}dxdy  
       = \pi \int_0^2 z(2z^2-2z+1)dz \NR
  \NC \NC = \pi \left.\left(\frac{1}{2}z^4-\frac{2}{3}z^3+\frac{1}{2}z^2\right)\right|_0^2  
       =\frac{14\pi}{3} \NR
\stopalign
\stopformula
...
\startformula
\bar{z}
= \frac{\displaystyle \iiint_{\Omega}zdxdydz}{\displaystyle \iiint_{\Omega}dxdydz}
=\frac{7}{5}
\stopformula
...
对于 $0\leq z \leq 1$, 记 $D_z=\left\{(x,y)|x^2+(y-z)^2\leq (1-z)^2\right\}$， 因为

\startformula
\startalign
  \NC  V \NC = \iiint_{\Omega}dxdydz = \int_0^1 dz \iint_{D_z}dxdy  
       = \int_0^1\pi(1-z)^2 dz=\frac{\pi}{3} \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC \iiint_{\Omega}ydxdydz \NC =  \int_0^1 dz \iint_{D_z}ydxdy  
        = \int_0^1dz\int_0^{2\pi}d\theta\int_0^{1-z}(z+r\sin\theta)rdr \NR
...
\startformula
\startalign
   \NC  \iiint_{\Omega}zdxdydz \NC =  \int_0^1 dz \iint_{D_z}zdxdy   
        = \int_0^1 \pi z (1-z)^2dz = \frac{\pi}{12} \NR
\stopalign
\stopformula
...
所以
\startformula
\bar{y}=\frac{\displaystyle \iiint_{\Omega}ydxdydz}{V}=\frac{1}{4}, \quad 
\bar{z}=\frac{\displaystyle \iiint_{\Omega}zdxdydz}{V}=\frac{1}{4},
\stopformula
故 $\Omega$ 的形心坐标为 $\left(0,\displaystyle\frac{1}{4},\frac{1}{4}\right)$
...
\startformula
\startalign
  \NC I_z \NC = \iiint_{\Omega} y^2\left(x^2+y^2\right)dv \NR
  \NC  \NC = 2\int_0^{\frac{\pi}{2}}d\theta\int_0^{2\cos\theta}r^5\sin^2\theta dr \int_{r^2}^{2r\cos\theta}dz  
      = \frac{64}{7}\int_0^{\frac{\pi}{2}} \left(\cos^8\theta - \cos^{10}\theta\right) d\theta \NR
...
\startformula
\startalign
  \NC F_z \NC = G\iiint_{\Omega} \frac{z-z_0}{r^3} dxdydz  
       = G\iiint_{\Omega} z\left(x^2+y^2+z^2\right)^{-\frac{3}{2}}dxdydz \NR
\stopalign
\stopformula
...
\startformula
\startalign
  \NC F_z \NC  = G\int_1^2 dz \iint_{D_z}z \left(x^2+y^2+z^2\right)^{-\frac{3}{2}}dxdy \NR
  \NC \NC = G\int_1^2dz \int_0^{2\pi}d\theta \int_0^{\sqrt{4-z^2}} z\left(r^2+z^2\right)^{-\frac{3}{2}} r dr  
       = G\pi \int_1^2 (2-z)dz = \frac{\pi}{2}G \NR
\stopalign
\stopformula
因此， 所求引力为 $F=\left(F_x, F_y, F_z\right) = \left(0,0,\displaystyle\frac{\pi G}{2}\right)$
